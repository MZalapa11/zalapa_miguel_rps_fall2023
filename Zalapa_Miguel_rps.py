...
def mouse_pos(x, y):
    ...
    if collide(x,y,rock_instance,rock_w,rock_h):
        ...
        text.penup()
        text.setpos(-400,20)
        text.write("You picked: Rock ", False, "left", ("Arial", 24, "normal"))
        if cpu_picked == "rock":
            cpu_show_rock(300,0)
            show_rock(300,0)
            ...
            text.penup()
            text.setpos(-400,-20)
            text.write("Computer picked: Rock ", False, "left", ("Arial", 24, "normal"))
            text.penup()
            text.setpos(-400,-60)
            text.write("Result: Tie", False, "left", ("Arial", 24, "normal"))
        if cpu_picked == "paper":
            show_paper(-1000,0)
            cpu_show_rock(300,0)
            ...
            text.penup()
            text.setpos(-400,-20)
            text.write("Computer picked: Paper ", False, "left", ("Arial", 24, "normal"))
            text.penup()
            text.setpos(-400,-60)
            text.write("Result: You Lose", False, "left", ("Arial", 24, "normal"))
        if cpu_picked == "scissors":
            ...
            text.penup()
            text.setpos(-400,-20)
            text.write("Computer picked: Scissors ", False, "left", ("Arial", 24, "normal"))
            text.penup()
            text.setpos(-400,-60)
            text.write("Result: You Win", False, "left", ("Arial", 24, "normal"))
            text.penup()
            text.setpos(-75,-190)
            text.write("Play Again", False, "left", ("Arial", 24, "normal"))
    if collide(x,y,paper_instance,rock_w,rock_h):
            print("I collided with paper...")
            play_paper()
            text.penup()
            text.setpos(-400,20)
            text.write("You picked: Paper ", False, "left", ("Arial", 24, "normal"))
            if cpu_picked == "paper":
                show_rock(-1000,0)
                cpu_show_paper(300,0)
                show_paper(300,0)
            ...
            text.setpos(-75,-190)
            text.write("Play Again", False, "left", ("Arial", 24, "normal"))
    if collide(x,y,scissors_instance,rock_w,rock_h):
            print("I collided with scissors...")
            play_paper()
            text.penup()
            text.setpos(-400,20)
            text.write("You picked: Scissors ", False, "left", ("Arial", 24, "normal"))
            if cpu_picked == "paper":
                show_rock(-1000,0)
                cpu_show_paper(300,0)
                show_scissors(300,0)
            ...
            if cpu_picked == "scissors":
                ...
                text.penup()
                text.setpos(-400,-60)
                text.write("Result: You Tie", False, "left", ("Arial", 24, "normal"))
            text.penup()
            text.setpos(-75,-190)
            text.write("Play Again", False, "left", ("Arial", 24, "normal"))
...
# sources: 
# https://bcpsj-my.sharepoint.com/personal/ccozort_bcp_org/_layouts/15/onedrive.aspx?ga=1&id=%2Fpersonal%2Fccozort%5Fbcp%5Forg%2FDocuments%2FDocuments%2F000%5FIntro%20to%20Programming%2F2023%5F2024%5FFall%2FCode%2FExamples%2Fcozort%5Fchris%5Frps%2Epy&parent=%2Fpersonal%2Fccozort%5Fbcp%5Forg%2FDocuments%2FDocuments%2F000%5FIntro%20to%20Programming%2F2023%5F2024%5FFall%2FCode%2FExamples